...
inline constexpr const char * WEATHER_BACKGROUND = "11.jpg"; // 天气模块背景图文件名
...
inline constexpr int WALLPAPER_SWITCH_INTERVAL_MS = 1000*5; // 壁纸切换周期（毫秒）
